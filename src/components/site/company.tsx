        ...
        <div className="grid items-start gap-14 grid-cols-1 md:grid-cols-2">
          <Reveal>
            ...
            <div className="mt-8 grid gap-3 grid-cols-1 sm:grid-cols-2">
              {facts.map((f) => (
                <div key={f.label} className="glass-subtle rounded-2xl p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        ...
        <div className="mt-12 space-y-3">
          {faqs.map((f, i) => (
            <Reveal key={f.q} delay={i * 80}>
              <details className="glass-subtle group rounded-2xl px-6 py-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
