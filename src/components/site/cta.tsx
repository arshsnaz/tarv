...
export function Cta() {
 ...
 <Reveal>
 <div className="glass relative flex h-full min-h-[450px] md:min-h-[600px] flex-col justify-center overflow-hidden -[2.5rem] bg-zinc-950/80 p-10 md:p-16 border border-white/5 dark:border-white/5 shadow-2xl transition-all hover:shadow-brand-soft/10">
 ...
 <a
 href="/access"
 className="group inline-flex items-center justify-center gap-2 bg-primary px-8 py-4 text-base font-bold text-primary-foreground shadow-[0_0_40px_-10px_rgba(255,255,255,0.2)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_60px_-10px_rgba(255,255,255,0.4)]"
 >
 ...
 <div className="pointer-events-none absolute -bottom-32 -left-32 size-[400px] bg-brand-soft/10 blur-[100px]" />
 </div>
 </Reveal>

 {/* Right Panel - Video */}
 <Reveal delay={150}>
 <div className="glass relative h-full min-h-[450px] md:min-h-[600px] overflow-hidden -[2.5rem] border border-white/5 dark:border-white/5 shadow-2xl transition-all hover:shadow-brand-soft/10">
 <video 
 src="/ref4.mp4"
 autoPlay
 loop
 ...
 <div className="pointer-events-none absolute inset-0 -[2.5rem] ring-1 ring-inset ring-white/10" />
 </div>
 </Reveal>
