...
export function SiteNav() {
 ...
 <div
 className={`flex w-full items-center gap-6 border border-border/40 bg-background/40 px-4 py-2.5 shadow-sm backdrop-blur-xl transition-all duration-500 sm:px-6 ${
 ...
 src={logoSrc}
 alt="TARV logo"
 className="size-7 shrink-0 bg-foreground/5 object-contain p-0.5 dark:invert"
 />
 ...
 {open ? (
 <div className="absolute inset-x-4 top-20 p-4 md:hidden border border-border bg-background/95 shadow-2xl backdrop-blur-xl">
 ...
 className=" px-4 py-3 text-left text-base font-medium text-foreground transition-colors hover:bg-accent"
 >
 {l.label}
 </button>
 ) : (
 ...
 className="block px-4 py-3 text-base font-medium text-foreground transition-colors hover:bg-accent"
 >
 {l.label}
 </a>
 )
