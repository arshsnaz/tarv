...
export function AiEngineer() {
  return (
    <section id="ai" className="panel-gradient relative py-32 overflow-hidden">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[800px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-soft/20 blur-[120px]" />
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <Reveal delay={150} className="relative mt-20 z-10">
          <div className="glass shadow-glass mx-auto max-w-6xl rounded-[2rem] p-3 md:p-4 transition-all duration-700 hover:shadow-brand-soft/20">
            <div className="relative overflow-hidden rounded-[1.5rem] bg-zinc-950 border border-white/10 dark:border-white/5 shadow-2xl">
              <video 
                src="/ref3.mp4"
                autoPlay
                loop
        ...
        <div className="relative z-20 mx-auto mt-16 md:-mt-16 grid max-w-6xl gap-6 grid-cols-1 md:grid-cols-3 px-2 md:px-8">
          {recs.map((r, i) => (
            <Reveal key={r.title} delay={200 + (i * 100)}>
              <div className="glass h-full rounded-3xl p-8 bg-background/80 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-white/10 dark:border-white/5">
